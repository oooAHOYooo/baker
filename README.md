...
This repository contains everything you need to set up a **Raspberry Pi 4** for a Unity-based game played on a TV, with support for **PS4 (Bluetooth)** and **Xbox 360 (USB)** controllers.
...
- **Xbox 360 Support**: Automated `xpad` driver loading and configuration.
...
#### Xbox 360 (Wired)
Just plug it into any USB port. It will be recognized automatically.
...
- The Xbox 360 controller will show up as `XInputController` or `Gamepad`.
